...
const validacion = yup.object().shape({
    ...
    juzgado: yup.string().required("Este es un campo obligatorio"),
    fecha: yup.date().required(),
    hora: yup.string().required(),
    tipo: yup.string().required("Este es un campo obligatorio"),
  })
          ...
          {({ handleSubmit }) => (
            <div className="ContainerInit">
              <form className="f" onSubmit={handleSubmit}> 
                ...
                <FormField name="tipo"     type="text"   placeholder="Agregar tipo" />
